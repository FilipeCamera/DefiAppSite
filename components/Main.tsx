...
const style = {
  ...
  transferPropContainer:
    "bg-[#20242A] my-3 rounded-2xl p-6 text-3xl border border-[#20242A] hover:border-[#41444F] flex justify-between",
  transferPropInput:
    "bg-transparent placeholder:text-[#B2B9D2] outline-none mb-6 w-full text-2xl",
  currencySelector: "flex w-1/4",
  currencySelectorContent:
    "w-full h-min flex justify-between items-center bg-[#2D2F36] hover:bg-[#41444F] rounded-2xl text-xl font-medium cursor-pointer p-2 mt-[-0.2rem]",
